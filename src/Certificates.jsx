...
const Certificates = forwardRef((props, ref) => {
  ...
  if (isModalOpen) {
    return <DetailedPopup isOpen={isModalOpen} onClose={closeModal} />;
  }
  return (
    <div
      ref={ref}
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center absolute inset-0 opacity-0 shadow-black group-hover:opacity-100 transition-opacity duration-300 z-20">
                ...
                <div className="relative flex self-center">
                  ...
                  >
                    <LuZoomIn
                      className={hoverZoom ? "text-blue-700" : "text-black"}
                      onClick={openModal}
                    />
                  </div>
                  ...
                  {/* Tooltip */}
                  <button
                    className="absolute top-full left-0  bg-black text-white text-xs px-2 py-2 font-normal mt-3 mx-4 transition-opacity duration-300"
                    style={{
